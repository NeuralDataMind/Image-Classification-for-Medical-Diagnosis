...
# Load the trained model (ensure the model path is correct in your project)
model_path = r"C:\Users\Mallikarjun\OneDrive\Desktop\Project_i\pneumonia_classification.keras"
